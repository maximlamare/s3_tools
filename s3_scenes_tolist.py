...
parser.add_argument('sites_csv',
                    metavar='CSV input file containing'
...
parser.add_argument('-e', '--end_date', default=datetime.now(),
                    metavar="enddate", help='Date to search images until')
...
parser.add_argument('-t', '--time_sort',
                    default=None,
                    metavar="timeofday",
...
for site in sites:
    ...
    for day in dates:
        s3_download(site_output, float(site[1]), float(site[2]),
